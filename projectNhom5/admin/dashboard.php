    ...
    <div id="main-wrapper">
        ...
        <div class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <li> <a href="contact.php"><i class="fa fa-address-book" aria-hidden="true"></i><span>Contact</span></a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="col-md-3">
                        <div class="card p-30" style="background-color: #CCFF00;">
                            <div class="media">
					 ...
					 <div class="col-md-3">
                        <div class="card p-30" style="background-color: #00CCFF;">
                            <div class="media">
                                <div class="media-left meida media-middle">
                    ...
                    <div class="col-md-3">
                        <div class="card p-30" style="background-color: #66FF33;">
                            <div class="media">
                                <div class="media-left meida media-middle">
					...
					<div class="col-md-3">
                        <div class="card p-30" style="background-color: #33FFFF;">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card p-30" style="background-color: #33FF66;">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
                    ...
                    <div class="col-md-4">
                        <div class="card p-30" style="background-color: yellow;">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
                    ...
                    <div class="col-md-4">
                        <div class="card p-30" style="background-color: #FFCC66;">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card p-30" style="background-color: #FFCCCC;">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
                    ...
                    <div class="col-md-4">
                        <div class="card p-30" style="background-color: #99CCFF;">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
